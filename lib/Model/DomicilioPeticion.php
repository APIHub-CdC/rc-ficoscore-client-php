...
class DomicilioPeticion implements ModelInterface, ArrayAccess
{
    ...
    protected static $RCCPMTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\rc\ficoscore\Client\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\rc\ficoscore\Client\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\rc\ficoscore\Client\Model\CatalogoTipoAsentamiento'
    ];
