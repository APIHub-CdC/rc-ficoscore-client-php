...
namespace rc\ficoscore\Client\Api;
...
use rc\ficoscore\Client\HeaderSelector;
...
class ReporteDeCreditoConFicoScoreApi
{
    ...
    {
        $returnType = '\rc\ficoscore\Client\Model\Consultas';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\Client\Model\Consultas',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\Client\Model\Errores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\Client\Model\Creditos';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\Client\Model\Creditos',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\Client\Model\DomiciliosRespuesta';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\Client\Model\DomiciliosRespuesta',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\Client\Model\Empleos';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\Client\Model\Empleos',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\Client\Model\Mensajes';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\Client\Model\Mensajes',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\Client\Model\Respuesta';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\Client\Model\Respuesta',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\rc\ficoscore\Client\Model\Scores';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\rc\ficoscore\Client\Model\Scores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
